...
python3 asa_ipsecVPN.py customer1 avav1
...
#
# create and send ipsec site to site VPN configuration
#
# -> create config file from template
    renderjinja2(args.customer, args.device, "ipsecsitetosite")
# -> send config to asa
    send_config(args.customer, args.device, "ipsecsitetosite")
